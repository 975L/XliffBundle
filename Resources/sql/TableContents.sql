...
INSERT INTO `translations` VALUES ('18', 'messages', 'text.copyright', 'Copyright', 'Copyright', null);
...
INSERT INTO `translations` VALUES ('101', 'messages', 'label.free', 'Free', 'Gratuit', null);
INSERT INTO `translations` VALUES ('102', 'messages', 'label.paying', 'Paying', 'Payant', null);
INSERT INTO `translations` VALUES ('103', 'messages', 'text.share', 'Share', 'Partager', null);
INSERT INTO `translations` VALUES ('104', 'messages', 'text.days', 'day(s)', 'jour(s)', null);
INSERT INTO `translations` VALUES ('105', 'messages', 'text.alert_must_signin_warning', 'I must sign in before being able to use this service', 'Je dois me connecter avant de pouvoir utiliser ce service', null);
INSERT INTO `translations` VALUES ('106', 'messages', 'text.move_mouse_over', 'Just move the cursor over buttons to see the action and click to launch', 'Juste passer le curseut au-dessus des boutons pour voir l\'action et cliquer pour lancer', null);
INSERT INTO `translations` VALUES ('107', 'messages', 'label.edit_profile', 'Edit my profile', 'Éditer mon profil', null);
INSERT INTO `translations` VALUES ('108', 'messages', 'label.credits', 'Credits', 'Crédits', null);
INSERT INTO `translations` VALUES ('109', 'messages', 'label.buy_credits', 'Buy credits %credits%', 'Acheter des crédits %credits%', null);
INSERT INTO `translations` VALUES ('110', 'messages', 'text.renew', 'Renew', 'Renouveler', null);
INSERT INTO `translations` VALUES ('111', 'messages', 'label.edition', 'Edition', 'Édition', null);
INSERT INTO `translations` VALUES ('112', 'messages', 'text.number', 'Number', 'Nombre', null);
INSERT INTO `translations` VALUES ('113', 'messages', 'text.alert_not_allowed', 'I am not allowed to use this resource', 'Je ne suis pas autorisé à utiliser cette ressource', null);
INSERT INTO `translations` VALUES ('114', 'messages', 'text.renew_for', 'Renew for', 'Renouveler pour', null);
INSERT INTO `translations` VALUES ('115', 'messages', 'label.year_s', 'year(s)', 'année(s)', null);
INSERT INTO `translations` VALUES ('116', 'messages', 'label.actions', 'Actions', 'Actions', null);
INSERT INTO `translations` VALUES ('117', 'messages', 'label.year', 'year', 'année', null);
INSERT INTO `translations` VALUES ('118', 'messages', 'label.account_data', 'Account data', 'Données du compte', null);
INSERT INTO `translations` VALUES ('119', 'messages', 'label.cost', 'Cost', 'Coût', null);
INSERT INTO `translations` VALUES ('120', 'messages', 'text.select_action_below', 'Select the action below', 'Sélectionner l\'action ci-dessous', null);
INSERT INTO `translations` VALUES ('121', 'messages', 'text.pricing', 'Pricing', 'Tarifs', null);
INSERT INTO `translations` VALUES ('122', 'messages', 'text.example', 'Example', 'Exemple', null);
INSERT INTO `translations` VALUES ('123', 'messages', 'label.discount', 'Discount', 'Rabais', null);
INSERT INTO `translations` VALUES ('124', 'messages', 'label.buy', 'Buy', 'Acheter', null);
INSERT INTO `translations` VALUES ('125', 'messages', 'label.payment', 'Payment', 'Paiement', null);
INSERT INTO `translations` VALUES ('126', 'messages', 'text.payment_info', 'To proceed the following payment, I click on the button below', 'Pour procéder au paiement suivant je clique sur le bouton ci-dessous', null);
INSERT INTO `translations` VALUES ('127', 'messages', 'label.description', 'Description', 'Description', null);
INSERT INTO `translations` VALUES ('128', 'messages', 'label.public', 'Public', 'Public', null);
INSERT INTO `translations` VALUES ('129', 'messages', 'label.private', 'Private', 'Privé', null);
INSERT INTO `translations` VALUES ('130', 'messages', 'label.access', 'Access', 'Accès', null);
INSERT INTO `translations` VALUES ('131', 'messages', 'text.disclaimer', 'Disclaimer', 'Avertissement', null);
INSERT INTO `translations` VALUES ('132', 'emails', 'text.mail_following_sent', 'The following message has been sent by <strong>%senderName%</strong> with the email address <strong><a href=\"mailto:%senderEmail%\">%senderEmail%</a></strong> on %sendTime% from <a href=\"http://975l.com\">http://975l.com</a>.', 'Le message ci-dessous a été envoyé par <strong>%senderName%</strong> avec l\'adresse email <strong><a href=\"mailto:%senderEmail%\">%senderEmail%</a></strong> le %sendTime% depuis <a href=\"http://run.as\">http://run.as</a>.', '');
INSERT INTO `translations` VALUES ('133', 'messages', 'label.message_sent', 'Message sent', 'Message envoyé', '');
INSERT INTO `translations` VALUES ('134', 'emails', 'text.greetings', 'Thanks you for your confidence!\r\n\r\nRegards,', 'Merci pour votre confiance !\r\n\r\nCordialement,', null);
INSERT INTO `translations` VALUES ('135', 'messages', 'label.thanks', 'Thanks', 'Remerciements', null);
INSERT INTO `translations` VALUES ('136', 'pages', 'text.thanks', 'This site would not have happened without the many players who make the web open source and free. We wish to thank the following actors', 'Ce site n\'aurait pas vu voir le jour sans les nombreux acteurs qui font le web opensource et gratuit. Nous tenons donc à remercier les acteurs suivants', null);
INSERT INTO `translations` VALUES ('137', 'pages', 'text.thanks_wikidurable', 'We also thank the <a href=\"%wikidurable_link%\">first contributors to wikidurable.org</a> that allowed the author to set foot in the stirrup and create this website.', 'Nous tenons aussi à remercier les <a href=\"%wikidurable_link%\">premiers contributeurs du site wikidurable.org</a> qui ont permis à l\'auteur de remettre le pied à l\'étrier et de créer ce site.', null);
INSERT INTO `translations` VALUES ('138', 'messages', 'label.receive', 'Receive', 'Recevoir', null);
INSERT INTO `translations` VALUES ('139', 'messages', 'label.remaining_credits', 'Remaining credits', 'Crédits restants', null);
INSERT INTO `translations` VALUES ('140', 'messages', 'label.new_balance', 'New balance', 'Nouveau solde', null);
INSERT INTO `translations` VALUES ('142', 'messages', 'label.years', 'years', 'années', null);
INSERT INTO `translations` VALUES ('144', 'messages', 'label.modify', 'Modify', 'Modifier', null);
INSERT INTO `translations` VALUES ('145', 'messages', 'label.modification', 'Modification', 'Modification', null);
INSERT INTO `translations` VALUES ('146', 'messages', 'text.delete_account', 'Delete account', 'Suppression du compte', null);
INSERT INTO `translations` VALUES ('147', 'messages', 'label.delete', 'Delete', 'Supprimer', null);
INSERT INTO `translations` VALUES ('148', 'messages', 'label.various', 'Various', 'Divers', null);
INSERT INTO `translations` VALUES ('149', 'messages', 'label.images', 'pictures', 'images', '');
INSERT INTO `translations` VALUES ('150', 'messages', 'label.es', 'Español\r\n', 'Español\r\n', 'Español\r\n');